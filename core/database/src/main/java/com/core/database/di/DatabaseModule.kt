            ...
            .addCallback(
                object : RoomDatabase.Callback() {
                    override fun onCreate(db: SupportSQLiteDatabase) {
                        ...
                        db.execSQL(
                            "INSERT INTO notes (content, tagId, timestamp) VALUES ('Welcome to your notes app! This is your first note.','1','" +
                                System.currentTimeMillis() +
                                "')",
                        )
                        db.execSQL(
                            "INSERT INTO notes (content, tagId, timestamp) VALUES ('You can add, edit, and delete notes here.','2','" +
                                System.currentTimeMillis() +
                                "')",
                        )
                        db.execSQL(
                            "INSERT INTO notes (content, tagId, timestamp) VALUES ('Try creating your own note by tapping the add button!','3','" +
                                System.currentTimeMillis() +
                                "')",
                        )
                        db.execSQL(
                            "INSERT INTO notes (content, tagId, timestamp) VALUES ('This app uses Room database to store your notes locally.','4','" +
                                System.currentTimeMillis() +
                                "')",
                        )
                        db.execSQL(
